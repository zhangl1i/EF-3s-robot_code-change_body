...
/**
 * @brief Display the battery power. 
 * 4.0--3.6--3.3--3.0--2.7
 */
void batteryIndicatior(void)
{

	if(adc5>4.0*65536/4/3.3)
	{		
	...
	if(adc5<=3.6*65536/4/3.3)
	{		
		HAL_GPIO_WritePin(GPIOD,GPIO_PIN_0,GPIO_PIN_SET);	
		if(adc5<3.0*65536/4/3.3)
		{				
